...
function sprig_setup() {
  ...
  // Community translations can be found at https://github.com/sprig/sprig-translations
  load_theme_textdomain('sprig', get_template_directory() . '/lang');
